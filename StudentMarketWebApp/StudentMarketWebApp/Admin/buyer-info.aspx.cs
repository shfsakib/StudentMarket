...
FROM            UserList INNER JOIN
                         ...
                         District ON UserList.District=District.DISTRICTID  WHERE UserList.Status='" + ddlStatus.SelectedValue + "' AND UserList.Type='Buyer' ORDER BY UserList.UserId ASC";
...
FROM            UserList INNER JOIN
                         Division ON UserList.Division=Division.ID INNER JOIN
                         District ON UserList.District=District.DISTRICTID  WHERE UserList.Status='" + ddlStatus.SelectedValue + "' AND UserList.Type='Buyer' AND UserList.NAME LIKE '%" + txtSearch.Text + "%'  ORDER BY UserList.UserId ASC";
            func.LoadGrid(profileGridView, query);
        }
