<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pending-ads.aspx.cs" Inherits="StudentMarketWebApp.Seller.pending_ads" %>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive" style="border: none;">
                                            <asp:GridView ID="adsGridView" style="color: darkgray" class="table table-bordered table-striped " runat="server" OnPageIndexChanging="adsGridView_OnPageIndexChanging" AutoGenerateColumns="False" ShowHeader="False" EmptyDataText="No Ads Found" ShowHeaderWhenEmpty="True" AllowPaging="True" PageSize="10">
                                                <Columns>
                                                        ...
                                                        <ItemTemplate>
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <asp:LinkButton ID="btnRemove" OnClick="btnRemove_OnClick" class="btn btn-danger wd" runat="server" Style="color: white; width: 100%" title="Remove"><i class="fas fa-trash-alt" style="color: white;"></i>&nbsp;&nbsp;Remove</asp:LinkButton>
                                                                         </div>
                                                                </div>
                                                            </div>
                                                        </ItemTemplate>
