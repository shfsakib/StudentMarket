<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pending-orders.aspx.cs" Inherits="StudentMarketWebApp.Buyer.pending_orders" %>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive" style="border: none; color: grey;">
                                            <asp:GridView ID="adsGridView" class="table table-bordered table-striped " runat="server" OnPageIndexChanging="adsGridView_OnPageIndexChanging" AutoGenerateColumns="False" ShowHeader="False" EmptyDataText="No Profile Found" ShowHeaderWhenEmpty="True" AllowPaging="True" PageSize="30">
                                                <Columns>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <br />
                                                                        <asp:Label ID="Label2" runat="server" Text="Order Quantity : "></asp:Label><span>
                                                                            <asp:Label ID="lblquantity" runat="server" Text='<%#Eval("Quantity")%>'></asp:Label>
                                                                            <br />
                                                                            <asp:Label ID="Label3" runat="server" Text="Dead Line : "></asp:Label><span>
                                                                                <asp:Label ID="Label4" runat="server" Text='<%#Eval("DeadLine")%>'></asp:Label>
                                                                            </span>
                                                                            <br />
